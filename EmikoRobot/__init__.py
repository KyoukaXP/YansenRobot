...
LOGGER.info("Yansen is starting. | An Yansensad Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/Yansensad (t.me/yansesat)")
...
DRAGONS.add(2004395661)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(2004395661)
DEV_USERS.add(5064309642)
