...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/96c01608cad3a46a280a2.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Yansen Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Yansen To Your Group ➗", url="t.me/YansennRobot?startgroup=new"
        ),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/c46b5dfde1e95777965ac.jpg"
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Yansen*, a powerful group management bot built to help you manage your group easily."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Source Code",
                            url="https://github.com/Yansensad/YansenRobot",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            text="*๏ Yansen support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Yansen.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="Support", url="t.me/yansensesat"),
                        InlineKeyboardButton(
                            text="Updates", url="https://t.me/ProjectYansen"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
